...
class VenueApproverAccepted extends StatelessWidget {
  final approver;
  final dropdownValue;
  final orgtype;
  const VenueApproverAccepted({Key key, this.approver, this.dropdownValue, this.orgtype}) : super(key: key);
  @override
                  ...
                  if(snapshot.hasData){
                      ...
                      if(values!=null){
                        ...
                        values.forEach((key, value){
                          if(value["status"].toString().contains("Accepted")){
                            count++;
                          }else{
                            print("okay");
                          }
