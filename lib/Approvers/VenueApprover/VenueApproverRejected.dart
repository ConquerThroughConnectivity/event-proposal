...
class VenueApproverRejected extends StatelessWidget {
  final approver;
  final dropdownValue;
  final orgtype;
  const VenueApproverRejected({Key key, this.approver, this.dropdownValue, this.orgtype}) : super(key: key);
  @override
        ...
        return CustomRefreshIndicator(
          ...
          child: Stack(
            ...
            GetBuilder<ApproverController>(
              ...
              child: StreamBuilder(
                stream:FirebaseDatabase.instance.reference().child("Venue").child("VenueReservation").orderByChild('approver_name').equalTo("${this.approver}").onValue,
                      ...
                      if(values!=null){
                        values.forEach((key, value){
                          ...
                          return Stack(
                            ...
                            if(values.values.toList()[index]['approver'].toString().contains("Rejected") && values.values.toList()[index]['incharge'].toString().contains("Accepted")){
                               return Slidable(
