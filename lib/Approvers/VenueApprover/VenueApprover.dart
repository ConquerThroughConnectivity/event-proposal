...
class VenueApproverPending extends StatelessWidget {
  final approver;
  final dropdownValue;
  final orgtype;
  final fullname;
  const VenueApproverPending({Key key, this.approver, this.dropdownValue, this.orgtype, this.fullname}) : super(key: key);
  @override
        ...
        return CustomRefreshIndicator(
          ...
          child: Stack(
            ...
            GetBuilder<ApproverController>(
              ...
              child: StreamBuilder(
                stream:this.approver ==null?FirebaseDatabase.instance.reference().child("Venue").child("VenueReservation").orderByChild('org_type').equalTo("${this.orgtype}").onValue:
                FirebaseDatabase.instance.reference().child("Venue").child("VenueReservation").orderByChild('approver_name').equalTo("${this.approver}").onValue,
                                   ...
                                   actions: [
                                     IconSlideAction(
                                      ...
                                      onTap: (){
                                        ...
                                        snapshots.popupInvalid("This request need to be sign by venue in charge", "Cannot Accept", context);
                                        }else{
                                        FirebaseDatabase.instance.reference().child("Venue").child("VenueReservation").child(values.keys.toList()[index]).update({
                                        "approver": ""+"Accepted",
                                        "name_approver": this.fullname,
                                        }).then((onValue){
