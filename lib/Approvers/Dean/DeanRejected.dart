...
class DeanRejected extends StatelessWidget {
  final approver;
  final dropdownValue;
  final orgtype;
  final orgname;
  ...
  final fullname;
  const DeanRejected ({Key key, this.approver, this.dropdownValue, this.orgtype, this.orgname, this.organization, this.fullname}) : super(key: key);
  @override
                  ...
                  if(snapshot.hasData){
                      ...
                      if(values!=null){
                        ...
                        values.forEach((key, value){
                          if(value["org_dean_status"].toString().contains("Rejected") && value["org_president_status"].toString().contains("Rejected")
                          ...
                          return Stack(children: [
                            ...
                            if(values.values.toList()[index]['org_president_status'].toString().contains("Rejected") &&
                                values.values.toList()[index]['org_adviser_status'].toString().contains("Rejected") && 
                                values.values.toList()[index]['org_dean_status'].toString().contains("Rejected")){
                               return Slidable(
