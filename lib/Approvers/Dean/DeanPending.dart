...
class DeanPending extends StatefulWidget {
  ...
  const DeanPending({Key key, this.approver, this.dropdownValue, this.orgtype, this.orgname, this.organization, this.fullname}) : super(key: key);
  @override
  _OrganizationApproverPendingState createState() => _OrganizationApproverPendingState();
}


class _OrganizationApproverPendingState extends State<DeanPending> {
                  ...
                  if(snapshot.hasData){
                      ...
                      if(values!=null){
                        ...
                        values.forEach((key, value){
                          if(value["org_dean_status"].toString().contains("Pending") && value["org_president_status"].toString().contains("Accepted")
