...
class VenueAccepted extends StatelessWidget {
  final approver;
  final dropdownValue;
  final orgtype;
  const VenueAccepted ({Key key, this.approver, this.dropdownValue, this.orgtype}) : super(key: key);
  @override
        ...
        return CustomRefreshIndicator(
          ...
          child: Stack(
            ...
            GetBuilder<ApproverController>(
              ...
              child: StreamBuilder(
                stream:FirebaseDatabase.instance.reference().child("Venue").child("VenueReservation").orderByChild('committee_in_charge').equalTo("${this.orgtype}").onValue,
                  ...
                  if(snapshot.hasData){
                      ...
                      if(values!=null){
                        ...
                        values.forEach((key, value){
                          if(value["status"].toString().contains("Accepted") ==null || value["status"].toString().contains("Accepted")){
                            count++;
                          }else{
                            print("okay");
                          }
                          ...
                          return Stack(children: [
                            ...
                            if(values.values.toList()[index]['incharge'].toString().contains("Accepted")){
                               return Slidable(
