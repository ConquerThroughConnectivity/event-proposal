...
import 'package:rflutter_alert/rflutter_alert.dart';
 bool isCount =false;
class VenuePending extends StatefulWidget {
  final approver;
  final dropdownValue;
  final orgtype;
  final fullname;

  const VenuePending({Key key, this.approver, this.dropdownValue, this.orgtype, this.fullname}) : super(key: key);
  @override
  _VenuePendingState createState() => _VenuePendingState();
}

class _VenuePendingState extends State<VenuePending> {
  @override
        ...
        return CustomRefreshIndicator(
          ...
          child: Stack(
            ...
            GetBuilder<ApproverController>(
              ...
              child: StreamBuilder(
                stream:FirebaseDatabase.instance.reference().child("Venue").child("VenueReservation").orderByChild('committee_in_charge').equalTo("${widget.orgtype}").onValue,
                                   ...
                                   IconSlideAction(
                                    ...
                                    onTap: (){
                                      ...
                                      Map<dynamic, dynamic> value =await snapshot.value;
                                                ...
                                                snapshots.popupInvalid("This Venue and date of event reservation already exist", "Cannot Continue",context);
                                                setState(() {
                                                isCount =false;
                                                });
                                                }else{
                                                setState(() {
                                                isCount =true;
                                               snapshots.popupInvalid('Great this Venue and date of event are vacant', "Valid", context);
                                              });
                                                  }
