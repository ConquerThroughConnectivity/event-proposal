...
class OrganizationApproverPending extends StatefulWidget {
  final approver;
  final dropdownValue;
  final orgtype;
  final orgname;
  ...
  const OrganizationApproverPending({Key key, this.approver, this.dropdownValue, this.orgtype, this.orgname, this.organization, this.fullname}) : super(key: key);
  @override
  _OrganizationApproverPendingState createState() => _OrganizationApproverPendingState();
}


class _OrganizationApproverPendingState extends State<OrganizationApproverPending> {
  ...
  void initState() {
    ...
    }else if(widget.organization.contains("Campus-Wide")){
      setState(() {
        isWide =false;        
      });
    } 
                  ...
                  if(snapshot.hasData){
                      ...
                      if(values!=null){
                        ...
                        values.forEach((key, value){
                          ...
                          if(value[adviser].toString().contains("Pending")){
                          ...
                          return Stack(children: [
                            ...
                            if(values.values.toList()[index]['org_name'].toString().contains(widget.approver)){
                              return Slidable(
