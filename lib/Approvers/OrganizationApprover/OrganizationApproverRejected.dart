...
class OrganizationApproverRejected extends StatelessWidget {
  final approver;
  final dropdownValue;
  final orgtype;
  final orgname;
  ...
  final fullname;
  const OrganizationApproverRejected({Key key, this.approver, this.dropdownValue, this.orgtype, this.orgname, this.organization, this.fullname}) : super(key: key);
  @override
                  ...
                  if(snapshot.hasData){
                      ...
                      if(values!=null){
                        ...
                        values.forEach((key, value){
                          ...
                          if(value["org_adviser_status"].toString().contains("Rejected") ==null ? 
                          value['org_president_status'].toString().contains("Rejected"):
                          value["org_adviser_status"].toString().contains("Rejected")
                           ){
                            count++;
                          ...
                          return Stack(children: [
                            ...
                            if(values.values.toList()[index]['org_adviser_status'].toString().contains("Rejected") ==null ?
                            values.values.toList()[index]['org_president_status'].toString().contains("Rejected") :
                            values.values.toList()[index]['org_adviser_status'].toString().contains("Rejected")){
                            if(values.values.toList()[index]['org_name'].toString().contains(this.approver)){
                              return Slidable(
