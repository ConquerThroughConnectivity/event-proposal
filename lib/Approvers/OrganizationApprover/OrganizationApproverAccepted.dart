...
class OrganizationApproverAccepted extends StatelessWidget {
  final approver;
  final dropdownValue;
  final orgtype;
  final orgname;
  final String organization;
  const OrganizationApproverAccepted({Key key, this.approver, this.dropdownValue, this.orgtype, this.orgname, this.organization}) : super(key: key);
  @override
                  ...
                  if(snapshot.hasData){
                      ...
                      if(values!=null){
                        ...
                        values.forEach((key, value){
                          ...
                          if(value["org_adviser_status"].toString().contains("Accepted") ==null ? 
                          value['org_president_status'].toString().contains("Accepted"):
                          ...
                          return Stack(
                            ...
                            if(values.values.toList()[index]['org_adviser_status'].toString().contains("Accepted") ==null ?
                            values.values.toList()[index]['org_president_status'].toString().contains("Accepted") :
