...
class TodayEvents extends StatefulWidget {
  @override
  _TodayEventsState createState() => _TodayEventsState();
}
...
class _TodayEventsState extends State<TodayEvents> {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
        ...
        child: StreamBuilder(
          stream: FirebaseDatabase.instance.reference().child("SAO").child("Proposal").orderByChild("date_of_event").equalTo(date).onValue,
