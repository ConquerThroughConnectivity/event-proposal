...
import 'package:eventproposal/utilities/DropDown.dart';
...
class SignupOrganization extends StatefulWidget {
  SignupOrganization({Key key}) : super(key: key);
...
@override
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: Text('Organization Signup', style: TextStyle(
          color: Colors.white,
          fontFamily: "Mops",
                ...
                children: <Widget>[
                  ...
                  Form(
                    ...
                    child: Card(
                      ...
                      child: isload ? CircularProgressIndicator(backgroundColor: Colors.red,) : Text('Register', style: TextStyle(
                        color: Colors.white,
                        fontFamily: "Mops",
                        fontSize: 20,
                        ),
                      ...
                      onPressed: () async {
                        ...
                        if(form.validate()){
                         ...
                         FirebaseDatabase.instance.reference().child("User").child("Organization").orderByChild("id").equalTo(schoolID.text)
                         .once().then((DataSnapshot snapshots) async { 
                           ...
                           if(values==null){
                              ...
                              isload=false;
                               ...
                               FirebaseDatabase.instance.reference().child("User").child("Organization").child(schoolID.text).set({
                                  'org_type': orgType,
                                  'org_name': orgname,
