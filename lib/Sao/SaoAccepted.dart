...
class SaoAccepted extends StatefulWidget {
  @override
  _SaoAcceptedState createState() => _SaoAcceptedState();
}

class _SaoAcceptedState extends State<SaoAccepted> {
  @override
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text(
            "Sao Accepted Proposal's", style: TextStyle(
             fontFamily: "Mops",
             fontSize: 20, 
            ),
          ),
        ...
        body: Container(
          ...
          child: StreamBuilder(
            stream: FirebaseDatabase.instance.reference().child("SAO").child("Proposal").orderByChild("status").equalTo("Accepted").onValue,
